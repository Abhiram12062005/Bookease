...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvas: HTMLCanvasElement): { gl: WebGLRenderingContext; ext: WebGLExtensions } {
      ...
      let gl =
        (canvas.getContext('webgl2', params) as WebGLRenderingContext | null) ??
    ...
    const displayMaterial        = new GLMaterial(baseVertexShader, displayShaderSource);
    ...
    function clickSplat(pointer: Pointer) {
      ...
      splat(pointer.texcoordX, pointer.texcoordY,
        6 * (Math.random() - 0.5), 18 * (Math.random() - 0.5), color);
    }
    ...
    function handleMouseMove(e: MouseEvent) {
      ...
      updatePointerMoveData(p, x, y, firstMove ? p.color : (firstMove = true, generateColor()));
    }
    ...
    function handleTouchEnd(e: TouchEvent) {
      for (const _ of Array.from(e.changedTouches)) updatePointerUpData(pointers[0]);
    }
